...
# Used in absolute url method to get url for specified ID
...
class Language(models.Model):
    ...
    name = models.CharField(max_length=200, unique=True, help_text="Enter the book's natural language (e.g. English, French, etc)")
